...
<a href="<?php echo URL_ROOT; ?>/admin/skills" class="btn btn-light"><i class="fa fa-backward"></i> Back</a>
<div class="card card-body bg-light mt-5">
   <h3>Add Skill</h3>
   <p>Create a new skill</p>
   <form action="<?php echo URL_ROOT; ?>/admin/skills/edit/<?php echo $data['id']; ?>" method="post">
