...
<div class="card card-body bg-light mt-5">
    ...
    <form action="<?php echo URL_ROOT; ?>/experiences/add" method="post">
        ...
        <div class="form-group">
            <label for="beginAt">BeginAt: <sup>*</sup></label>
            <input type="date" name=beginAt" id="beginAt" class="form-control form-control <?php echo (!empty($data['beginAt_err'])) ? 'is-invalid' : '';?>" value="<?php echo $data['beginAt']; ?>">
