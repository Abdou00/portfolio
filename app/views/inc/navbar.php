<nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-3">
   ...
   <div class="collapse navbar-collapse" id="navbarsExampleDefault">
      <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
              <a class="nav-link" href="<?php echo URL_ROOT;?>/admin/index/">Admin</a>
          </li>
          <?php endif; ?>
          <li class="nav-item">
          ...
          <li class="nav-item">
              <a class="nav-link" href="<?php echo URL_ROOT;?>/skills/">Skills</a>
          </li>
          <li class="nav-item">
              <a class="nav-link" href="<?php echo URL_ROOT;?>/experiences/">Experiences</a>
          </li>
          <li class="nav-item">
              <a class="nav-link" href="<?php echo URL_ROOT;?>/projects/">Projects</a>
          </li>
      </ul>
      ...
      <ul class="navbar-nav mr-right">
          ...
          <li class="nav-item">
             <a class="nav-link" href="<?php echo URL_ROOT;?>/users/register"><i class="fa fa-sign-in"></i> Register </a>
          </li>
          <?php endif; ?>
      </ul>
</nav>
